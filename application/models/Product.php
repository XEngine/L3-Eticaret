...
class Product extends Eloquent {
	...
	public $includes = array('getDetail','getCategory','getAttributes','getAttributes.fetchGroup','getAttributes.fetchGroup.getTopGroup','getComments','getImages','getBrand','getDiscount',"getTax");
	/**
